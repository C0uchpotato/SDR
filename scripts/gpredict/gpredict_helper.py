...
min_elevation_deg = 10       # minimum elevation (degrees)
observer_lat = 35.2271
observer_lon = -80.8431
observer_alt_m = 0
lookahead_days = 7           # how far ahead to search
max_passes_to_show = 8       # number of passes to display
    ...
    while True:
        ...
        if not all_passes:
            ...
            for aos, los, max_el, name in all_passes:
                ...
                countdown_str = color_countdown(countdown if countdown.total_seconds() > 0 else "In Progress")
